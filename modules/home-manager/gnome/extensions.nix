...
{
  options.caden.gnome.shell.extensions = {
  ...
  config.programs.gnome-shell.extensions =
    lib.optionals config.caden.gnome.shell.extensions.blur-my-shell.enable [
      { package = pkgs.gnomeExtensions.blur-my-shell; }
    ]
    ++ lib.optionals config.caden.gnome.shell.extensions.caffeine.enable [
      { package = pkgs.gnomeExtensions.caffeine; }
    ]
    ++ lib.optionals config.caden.gnome.shell.extensions.appindicator.enable [
      { package = pkgs.gnomeExtensions.appindicator; }
    ]
    ++ lib.optionals config.caden.gnome.shell.extensions.copyous.enable [
      { package = pkgs.gnomeExtensions.copyous; }
    ]
    ++ lib.optionals config.caden.gnome.shell.extensions.tint-my-gnome.enable [
